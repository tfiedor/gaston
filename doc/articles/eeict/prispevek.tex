...
\abstract{Various types of logics are often used as a mean for a formal
...
deterministic automata. The aim of this work is to exploit the recently
developed techniques for efficient manipulation of non-deterministic tree
automata and implement an efficient decision procedure based on those.}
...
\begin{figure}
 \begin{center}
  \scalebox{0.6}{\includegraphics{formula-singleton-and-subset.pdf}}
  \scalebox{0.6}{\includegraphics{formula-automaton-product.pdf}}
  \scalebox{0.6}{\includegraphics{formula-automaton.pdf}}
 \end{center}
