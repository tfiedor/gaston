...
\projectinfo{
  ...
  year=2014,             %rok
  date={23. kvìtna 2014},           %datum odevzdani
  %Nazev prace
  ...
  %Abstract
  %abstract.cs={Rùzné typy logik se èasto pou¾ívají jako prostøedky pro formální specifikaci systémù. Slabá monadická logika druhého øádu s~$k$ následníky (WS$k$S) je jednou z~nich a by» má pomìrnì velkou vyjadøovací sílu, stále je rozhodnutelná. Aèkoliv slo¾itost testování splnitelnosti WS$k$S formule není ani ve tøídì ELEMENTARY, tak existují pøístupy zalo¾ené na deterministických automatech, implementované napø. v nástroji \textsc{MONA}, které efektnì øe¹í omezenou tøídu praktických pøíkladù, nicménì nefungují pro jiné. Tato práce roz¹iøuje tøídu prakticky øe¹itelných pøíkladù, a to tak, ¾e vyu¾ívá nedávno vyvinutých technik pro efektní manipulaci s nedeterministickými automaty (jako je napøíklad testování universality jazyka pomocí pøístupu zalo¾eného na antichainech) a navrhuje novou rozhodovací proceduru pro WS$k$S vyu¾ívající právì nedeterministické automaty. Procedura je implementována a ve srovnání s nástrojem \textsc{MONA} dosahuje v nìkterých pøípadech øádovì lep¹ích výsledkù.}, % abstrakt v ceskem jazyce
  ...
  acknowledgment={I thank my supervisor, Ing.\ Ondøej Lengál, for his contribution, his time for discussions, motivation and patience. Further, I wish to thank prof.\ doc.\ Ing. Tomá¹ Vojnar,~Ph.\ D., and Mgr.\ Luká¹ Holík,~Ph.\ D.\, for their time for discussions. My thanks also go to everyone who supported me during my studies: my friends and my family.\\ \indent This work was supported by the Czech Science Foundation under the project 14-11384S as well as the internal BUT projects FIT-S-12-1 and FIT-S-14-2486. }
