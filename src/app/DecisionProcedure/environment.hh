...
#define MEASURE_CONTINUATION_CREATIO    true    // < Measures how many continuations are created
...
#define OPT_SHUFFLE_FORMULA                 false // < Will run ShuffleVisitor before creation of automaton, which should ease the procedure as well
